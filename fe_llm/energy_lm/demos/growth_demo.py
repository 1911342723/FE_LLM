...
运行：
    python -m fe_llm.energy_lm.demos.growth_demo
"""
...
from fe_llm.energy_lm.diagnostics.collapse import EnergyCollapseChat, MemoryBank
...
from fe_llm.energy_lm.training.train import CKPT_NET, CKPT_TOK
...
def main():
    if not os.path.exists(CKPT_NET):
        print("未找到权重，请先 python -m fe_llm.energy_lm.training.train")
        return
    device = get_device()
