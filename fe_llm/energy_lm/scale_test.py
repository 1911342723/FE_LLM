...
运行：
    python -m fe_llm.energy_lm.scale_test          # 训练 + 评测
    python -m fe_llm.energy_lm.scale_test --eval   # 只评测(需已训练)
"""
...
from fe_llm.energy_lm.real_data import char_set, load_clean_sentences
