...
运行：
    python -m fe_llm.energy_lm.ablation_per
"""
...
from fe_llm.energy_lm.corpus import DIALOGUES
from fe_llm.energy_lm.energy_net import DialogueEnergyNet
from fe_llm.energy_lm.tokenizer import build_tokenizer
from fe_llm.energy_lm.train import SEQ_LEN, DIM, DEPTH, NHEADS, make_dataset
