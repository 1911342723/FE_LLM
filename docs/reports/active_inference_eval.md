...
|---|---:|---:|
| `answer` | 0.991 | 0.986 |
| `ask_clarification` | 0.890 | 0.942 |
| `retrieve` | 0.859 | 0.874 |
| `refuse` | 0.971 | 1.000 |
| `update_memory` | 0.954 | 0.873 |
...
|---|---:|---:|---:|---:|---:|
| `answer` | 1533 | 0 | 0 | 0 | 14 |
| `ask_clarification` | 4 | 210 | 22 | 0 | 0 |
| `retrieve` | 13 | 11 | 159 | 0 | 2 |
| `refuse` | 0 | 2 | 0 | 134 | 2 |
| `update_memory` | 5 | 0 | 1 | 0 | 124 |
...
- final selector validation accuracy: 0.960
...
- final prediction distribution: `{'update_memory': 141, 'answer': 1551, 'refuse': 144, 'ask_clarification': 211, 'retrieve': 189}`
...
|---|---:|---:|
| `answer` | 0.992 | 0.989 |
| `ask_clarification` | 0.826 | 0.924 |
| `retrieve` | 0.843 | 0.825 |
| `refuse` | 0.993 | 0.951 |
| `update_memory` | 0.954 | 0.879 |
